...
<td><p>Routines for making games with rooms with randomly-generated connections</p></td>
<td><p>2.5+</p></td>
<td><p>Works fine</p></td>
...
|---------------------------------|----------------------------------------------------------------------------------------------------|--------------|--------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
| [Automap](Automap)   | Provides Beyond Zork-like map capabilities to games.                                               | 2.5          | Touched up and made glk-compatible as NewAutomap but this is the original.                                   | [Yes](http://ifarchive.smallwhitehouse.org/if-archive/programming/hugo/library/contributions/automap.zip)  |
| [Boxdraw](Boxdraw.h) | Draws quote boxes either in main window or floating above text.                                    | 2.4          | Updated and turned into [NewBoxdraw](NewBoxdraw.h)                                                | [Yes](http://ifarchive.smallwhitehouse.org/if-archive/programming/hugo/library/contributions/boxdraw.h)    |
...
| Menu                            | Menu replacement                                                                                   | 2.1          | This has since been made obsolete by the latest version of Hugo's official [Menu](Menu) routine.  | [Yes](http://ifarchive.smallwhitehouse.org/if-archive/programming/hugo/library/contributions/menu.txt)     |
