...
`ListObjects(object)` lists all the possessions of the specified object in the appropriate form (according to the global [FORMAT](FORMAT).

Possessions of possessions are listed recursively if [FORMAT](FORMAT) does not contain the `NORECURSE_F` bit.

Also calls: [WhatsIn](WhatsIn)
...
Check out the [FORMAT](FORMAT) page for more listing options.
